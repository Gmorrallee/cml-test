...
module "identity_uks_to_connectivity_uks_vnet_peering" {
  ...
  name                      = "vnet-identity-uksouth-to-vnet-connectivity-uksouth"
  parent_id                 = module.vnet_identity_uksouth.resource_id
  remote_virtual_network_id = module.vnet_connectivity_uksouth.resource_id
...
module "identity_uks_to_connectivity_ukwest_vnet_peering" {
  ...
  name                      = "vnet-identity-uksouth-to-vnet-connectivity-ukwest"
  parent_id                 = module.vnet_identity_uksouth.resource_id
